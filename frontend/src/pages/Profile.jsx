...
const ProfilePage = () => {
  ...
  return (
    <div className='min-h-screen bg-background text-foreground'>
      <Header />
      <main className='container mx-auto flex w-full flex-col gap-6 py-6'>
        <section>
            ...
            <CardHeader className='items-center text-center'>
              <div className='relative'>
                <Avatar className='size-28'>
                  {avatar ? (
                    <AvatarImage src={avatar} alt={name || email || 'User'} />
                  ) : null}
              ...
              <CardHeader>
                <div className='flex items-center gap-2'>
                  ...
                  <div>
                    ...
                    <CardDescription>
                      Update your display name and review your login email.
                    </CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
                <form className='grid gap-4' onSubmit={handleChangeName}>
            ...
            <Card>
              <CardHeader>
                <div className='flex items-center gap-2'>
                  ...
                  <div>
                    ...
                    <CardDescription>
                      Change your password periodically to keep your workspace
                      protected.
                    </CardDescription>
                  </div>
                </div>
              ...
              <CardContent className='flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between'>
                <p className='text-sm text-muted-foreground'>
                  Password changes apply immediately to your account.
                </p>
                <ChangePassword />
              </CardContent>
            </Card>
