...
const BoardPage = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 text-slate-950">
            <Header />
            <main className="container mx-auto flex w-full max-w-7xl flex-grow flex-col gap-8 py-6 lg:px-8">
                <section className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-slate-600">
                            Open a project to draw labels, save annotations, or
                            invite reviewers.
                        </p>
                    </div>
                    <NewBoard />
                            ...
                            {boards.length ? (
                                ...
                                <div className="flex min-h-[360px] flex-col items-center justify-center rounded-lg border border-dashed border-slate-300 bg-white px-6 text-center">
                                    ...
                                    <p className="mt-2 max-w-md text-sm leading-6 text-slate-600">
                                        Create your first segmentation project by
                                        uploading an image and giving it a clear
                                        name.
                                    </p>
                                    <div className="mt-5">
                                        <NewBoard />
